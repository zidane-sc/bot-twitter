...
var TweetsV2Client = /** @class */ (function () {
    function TweetsV2Client(transport) {
        if (!transport) {
     ...
     * @param parameters
     */
    TweetsV2Client.prototype.createTweet = function (parameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.transport.doPostRequest('https://api.twitter.com/2/tweets', parameters, 'application/json')];
     ...
     * @param parameters
     */
    TweetsV2Client.prototype.deleteTweet = function (parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.transport.doDeleteRequest('https://api.twitter.com/2/tweets/' + params)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     * @param parameters
     */
    TweetsV2Client.prototype.searchRecentTweets = function (parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        params = utils_1.createParams(parameters);
                        return [4 /*yield*/, this.transport.doGetRequest('https://api.twitter.com/2/tweets/search/recent' + params)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     * @param parameters
     */
    TweetsV2Client.prototype.searchAllTweets = function (parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        params = utils_1.createParams(parameters);
                        return [4 /*yield*/, this.transport.doGetRequest('https://api.twitter.com/2/tweets/search/all' + params)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    return TweetsV2Client;
}());
exports.default = TweetsV2Client;
